...
-- -----------------------------------------------------
-- Table `mydb`.`Cabecera_Orden`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Cabecera_Orden` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Cabecera_Orden` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Detalle_Orden` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Detalle_Orden` (
  ...
  CONSTRAINT `fk_Detalle_Orden_Cabecera_Orden1`
    ...
    REFERENCES `mydb`.`Cabecera_Orden` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
