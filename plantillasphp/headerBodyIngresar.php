				...
				<header>
					...
					<nav>
						<ul id="top_nav">
							...
							<li><a href="registrar.php"><img src="../images/icon_2.gif" alt=""></a></li>
							<li class="end"><a href="ayuda.php"><img src="../images/icon_3.gif" alt=""></a></li>
						</ul>
					</nav>
					<nav>
						<ul id="menu">
                            ...
                            </li><li><a href="../pages/nosotros.php">Nosotros</a></li>
						</ul>
					</nav>
				</header>
<!-- / header -->
