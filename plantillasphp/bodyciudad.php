	...
	<div class="body1">
		<div class="body5">
			...
			<?php include '../plantillasphp/headerRCC.php' ; ?>
				...
				<h2 id="titulopag"> Ciudades </h2> <form> <input  href="#" class="button1" id="seccionbuscar" type="submit" value="Buscar"><br><br> <input  id="seccionbuscar" type="search" name="buscar"></form><br>
